...
public class GoogleSQLLexer extends Lexer {
	...
	public static final int
		...
		NULL_FILTERED_SYMBOL=236, PARENT_SYMBOL=237, NEW_SYMBOL=238, END_SYMBOL=239, 
		CASE_SYMBOL=240, WHEN_SYMBOL=241, THEN_SYMBOL=242, ELSE_SYMBOL=243, CAST_SYMBOL=244, 
		EXTRACT_SYMBOL=245, COLLATE_SYMBOL=246, IF_SYMBOL=247, GROUPING_SYMBOL=248, 
		HAVING_SYMBOL=249, GROUP_SYMBOL=250, ROLLUP_SYMBOL=251, CUBE_SYMBOL=252, 
		HASH_SYMBOL=253, PROTO_SYMBOL=254, PARTITION_SYMBOL=255, IGNORE_SYMBOL=256, 
		RESPECT_SYMBOL=257, ROWS_SYMBOL=258, OVER_SYMBOL=259, BETWEEN_SYMBOL=260, 
		UNBOUNDED_SYMBOL=261, CURRENT_SYMBOL=262, PRECEDING_SYMBOL=263, FOLLOWING_SYMBOL=264, 
		ASTERISK_SYMBOL=265, COMMA_SYMBOL=266, DOT_SYMBOL=267, EQUAL_SYMBOL=268, 
		LC_BRACKET_SYMBOL=269, RC_BRACKET_SYMBOL=270, LT_BRACKET_SYMBOL=271, GT_BRACKET_SYMBOL=272, 
		LR_BRACKET_SYMBOL=273, RR_BRACKET_SYMBOL=274, LS_BRACKET_SYMBOL=275, RS_BRACKET_SYMBOL=276, 
		COLON_SYMBOL=277, SEMI_SYMBOL=278, SINGLE_QUOTE_SYMBOL=279, SINGLE_QUOTE_3_SYMBOL=280, 
		DOUBLE_QUOTE_SYMBOL=281, DOUBLE_QUOTE_3_SYMBOL=282, BACKQUOTE_SYMBOL=283, 
		DASH_SYMBOL=284, QUESTION_SYMBOL=285, AT_SYMBOL=286, ATAT_SYMBOL=287, 
		EQUAL_GT_BRACKET_SYMBOL=288, SUB_GT_BRACKET_SYMBOL=289, PLUS_EQUAL_SYMBOL=290, 
		SUB_EQUAL_SYMBOL=291, QUOTED_ID=292, ID=293, INT=294, FLOAT=295, STRING_LITERAL=296, 
		BYTES_LITERAL=297, UNCLOSED_STRING_LITERAL=298, UNCLOSED_TRIPLE_QUOTED_STRING_LITERAL=299, 
		UNCLOSED_RAW_STRING_LITERAL=300, UNCLOSED_TRIPLE_QUOTED_RAW_STRING_LITERAL=301, 
		UNCLOSED_BYTES_LITERAL=302, UNCLOSED_TRIPLE_QUOTED_BYTES_LITERAL=303, 
		UNCLOSED_RAW_BYTES_LITERAL=304, UNCLOSED_TRIPLE_QUOTED_RAW_BYTES_LITERAL=305, 
		INTEGER_LITERAL=306, IDENTIFIER=307, UNCLOSED_ESCAPED_IDENTIFIER=308, 
		WHITESPACE=309;
