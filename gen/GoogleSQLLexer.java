// Generated from /home/h3n4l/OpenSource/google-sql-parser/GoogleSQLLexer.g4 by ANTLR 4.13.2
...
public class GoogleSQLLexer extends Lexer {
	...
	public static final int
		...
		OR_SYMBOL=58, JSON_SYMBOL=59, DATE_SYMBOL=60, TIME_SYMBOL=61, DATETIME_SYMBOL=62, 
		TIMESTAMP_SYMBOL=63, RANGE_SYMBOL=64, INTERVAL_SYMBOL=65, SIMPLE_SYMBOL=66, 
		ABORT_SYMBOL=67, ACCESS_SYMBOL=68, ACTION_SYMBOL=69, AGGREGATE_SYMBOL=70, 
		ADD_SYMBOL=71, ALTER_SYMBOL=72, ALWAYS_SYMBOL=73, ANALYZE_SYMBOL=74, APPROX_SYMBOL=75, 
		ARE_SYMBOL=76, ASSERT_SYMBOL=77, BATCH_SYMBOL=78, BEGIN_SYMBOL=79, BREAK_SYMBOL=80, 
		CALL_SYMBOL=81, CASCADE_SYMBOL=82, CHECK_SYMBOL=83, CLAMPED_SYMBOL=84, 
		CLONE_SYMBOL=85, COPY_SYMBOL=86, CLUSTER_SYMBOL=87, COLUMN_SYMBOL=88, 
		COLUMNS_SYMBOL=89, COMMIT_SYMBOL=90, CONNECTION_SYMBOL=91, CONSTANT_SYMBOL=92, 
		CONSTRAINT_SYMBOL=93, CONTINUE_SYMBOL=94, CORRESPONDING_SYMBOL=95, CYCLE_SYMBOL=96, 
		DATA_SYMBOL=97, DATABASE_SYMBOL=98, DECLARE_SYMBOL=99, DEFINER_SYMBOL=100, 
		DELETE_SYMBOL=101, DELETION_SYMBOL=102, DEPTH_SYMBOL=103, DESCRIBE_SYMBOL=104, 
		DETERMINISTIC_SYMBOL=105, DO_SYMBOL=106, DROP_SYMBOL=107, ELSEIF_SYMBOL=108, 
		ENFORCED_SYMBOL=109, ERROR_SYMBOL=110, EXCEPTION_SYMBOL=111, EXECUTE_SYMBOL=112, 
		EXPLAIN_SYMBOL=113, EXPORT_SYMBOL=114, EXTEND_SYMBOL=115, EXTERNAL_SYMBOL=116, 
		FILES_SYMBOL=117, FILTER_SYMBOL=118, FILL_SYMBOL=119, FIRST_SYMBOL=120, 
		FOREIGN_SYMBOL=121, FORMAT_SYMBOL=122, FUNCTION_SYMBOL=123, GENERATED_SYMBOL=124, 
		GRANT_SYMBOL=125, GROUP_ROWS_SYMBOL=126, HIDDEN_SYMBOL=127, IDENTITY_SYMBOL=128, 
		IMMEDIATE_SYMBOL=129, IMMUTABLE_SYMBOL=130, IMPORT_SYMBOL=131, INCREMENT_SYMBOL=132, 
		INDEX_SYMBOL=133, INOUT_SYMBOL=134, INPUT_SYMBOL=135, INSERT_SYMBOL=136, 
		INVOKER_SYMBOL=137, ISOLATION_SYMBOL=138, ITERATE_SYMBOL=139, KEY_SYMBOL=140, 
		LANGUAGE_SYMBOL=141, LAST_SYMBOL=142, LEAVE_SYMBOL=143, LEVEL_SYMBOL=144, 
		LOAD_SYMBOL=145, LOOP_SYMBOL=146, MACRO_SYMBOL=147, MAP_SYMBOL=148, MATCH_SYMBOL=149, 
		KW_MATCH_RECOGNIZE_NONRESERVED_SYMBOL=150, MATCHED_SYMBOL=151, MATERIALIZED_SYMBOL=152, 
		MAX_SYMBOL=153, MAXVALUE_SYMBOL=154, MEASURES_SYMBOL=155, MESSAGE_SYMBOL=156, 
		METADATA_SYMBOL=157, MIN_SYMBOL=158, MINVALUE_SYMBOL=159, MODEL_SYMBOL=160, 
		MODULE_SYMBOL=161, ONLY_SYMBOL=162, OUT_SYMBOL=163, OUTPUT_SYMBOL=164, 
		OVERWRITE_SYMBOL=165, PARTITIONS_SYMBOL=166, PATTERN_SYMBOL=167, POLICIES_SYMBOL=168, 
		POLICY_SYMBOL=169, PRIMARY_SYMBOL=170, PRIVATE_SYMBOL=171, PRIVILEGE_SYMBOL=172, 
		PRIVILEGES_SYMBOL=173, PROCEDURE_SYMBOL=174, PROJECT_SYMBOL=175, PUBLIC_SYMBOL=176, 
		RAISE_SYMBOL=177, READ_SYMBOL=178, REFERENCES_SYMBOL=179, REMOTE_SYMBOL=180, 
		REMOVE_SYMBOL=181, RENAME_SYMBOL=182, REPEAT_SYMBOL=183, REPEATABLE_SYMBOL=184, 
		REPLACE_FIELDS_SYMBOL=185, REPLICA_SYMBOL=186, REPORT_SYMBOL=187, RESTRICT_SYMBOL=188, 
		RESTRICTION_SYMBOL=189, RETURNS_SYMBOL=190, RETURN_SYMBOL=191, REVOKE_SYMBOL=192, 
		ROLLBACK_SYMBOL=193, ROW_SYMBOL=194, RUN_SYMBOL=195, SAFE_CAST_SYMBOL=196, 
		SCHEMA_SYMBOL=197, SEARCH_SYMBOL=198, SECURITY_SYMBOL=199, SEQUENCE_SYMBOL=200, 
		SETS_SYMBOL=201, SHOW_SYMBOL=202, SNAPSHOT_SYMBOL=203, SOURCE_SYMBOL=204, 
		SQL_SYMBOL=205, STABLE_SYMBOL=206, START_SYMBOL=207, STATIC_DESCRIBE_SYMBOL=208, 
		STORED_SYMBOL=209, STORING_SYMBOL=210, STRICT_SYMBOL=211, TABLE_SYMBOL=212, 
		TABLES_SYMBOL=213, TARGET_SYMBOL=214, TEMP_SYMBOL=215, TEMPORARY_SYMBOL=216, 
		TRANSACTION_SYMBOL=217, TRANSFORM_SYMBOL=218, TRUNCATE_SYMBOL=219, TYPE_SYMBOL=220, 
		UNDROP_SYMBOL=221, UNIQUE_SYMBOL=222, UNKNOWN_SYMBOL=223, UNTIL_SYMBOL=224, 
		UPDATE_SYMBOL=225, VALUES_SYMBOL=226, VECTOR_SYMBOL=227, VIEW_SYMBOL=228, 
		VIEWS_SYMBOL=229, VOLATILE_SYMBOL=230, WEIGHT_SYMBOL=231, WHILE_SYMBOL=232, 
		WRITE_SYMBOL=233, ZONE_SYMBOL=234, DESCRIPTOR_SYMBOL=235, INTERLEAVE_SYMBOL=236, 
		NULL_FILTERED_SYMBOL=237, PARENT_SYMBOL=238, NEW_SYMBOL=239, END_SYMBOL=240, 
		CASE_SYMBOL=241, WHEN_SYMBOL=242, THEN_SYMBOL=243, ELSE_SYMBOL=244, CAST_SYMBOL=245, 
		EXTRACT_SYMBOL=246, COLLATE_SYMBOL=247, IF_SYMBOL=248, GROUPING_SYMBOL=249, 
		HAVING_SYMBOL=250, GROUP_SYMBOL=251, ROLLUP_SYMBOL=252, CUBE_SYMBOL=253, 
		HASH_SYMBOL=254, PROTO_SYMBOL=255, PARTITION_SYMBOL=256, IGNORE_SYMBOL=257, 
		RESPECT_SYMBOL=258, ROWS_SYMBOL=259, OVER_SYMBOL=260, BETWEEN_SYMBOL=261, 
		UNBOUNDED_SYMBOL=262, CURRENT_SYMBOL=263, PRECEDING_SYMBOL=264, FOLLOWING_SYMBOL=265, 
		NATURAL_SYMBOL=266, QUALIFY_SYMBOL=267, DEFAULT_SYMBOL=268, SLASH_SYMBOL=269, 
		MATCH_RECOGNIZE_SYMBOL=270, DEFINE_SYMBOL=271, LOOKUP_SYMBOL=272, WHERE_SYMBOL=273, 
		WINDOW_SYMBOL=274, TO_SYMBOL=275, EXISTS_SYMBOL=276, NOT_SPECIAL_SYMBOL=277, 
		ANY_SYMBOL=278, SOME_SYMBOL=279, LIKE_SYMBOL=280, MINUS_SYMBOL=281, PLUS_SYMBOL=282, 
		ASTERISK_SYMBOL=283, COMMA_SYMBOL=284, DOT_SYMBOL=285, EQUAL_SYMBOL=286, 
		LC_BRACKET_SYMBOL=287, RC_BRACKET_SYMBOL=288, LT_BRACKET_SYMBOL=289, GT_BRACKET_SYMBOL=290, 
		LR_BRACKET_SYMBOL=291, RR_BRACKET_SYMBOL=292, LS_BRACKET_SYMBOL=293, RS_BRACKET_SYMBOL=294, 
		STROKE_SYMBOL=295, COLON_SYMBOL=296, SEMI_SYMBOL=297, SINGLE_QUOTE_SYMBOL=298, 
		SINGLE_QUOTE_3_SYMBOL=299, DOUBLE_QUOTE_SYMBOL=300, DOUBLE_QUOTE_3_SYMBOL=301, 
		BACKQUOTE_SYMBOL=302, QUESTION_SYMBOL=303, AT_SYMBOL=304, ATAT_SYMBOL=305, 
		EQUAL_GT_BRACKET_SYMBOL=306, SUB_GT_BRACKET_SYMBOL=307, PLUS_EQUAL_SYMBOL=308, 
		SUB_EQUAL_SYMBOL=309, PIPE_SYMBOL=310, QUOTED_ID=311, ID=312, STRING_LITERAL=313, 
		BYTES_LITERAL=314, UNCLOSED_STRING_LITERAL=315, UNCLOSED_TRIPLE_QUOTED_STRING_LITERAL=316, 
		UNCLOSED_RAW_STRING_LITERAL=317, UNCLOSED_TRIPLE_QUOTED_RAW_STRING_LITERAL=318, 
		UNCLOSED_BYTES_LITERAL=319, UNCLOSED_TRIPLE_QUOTED_BYTES_LITERAL=320, 
		UNCLOSED_RAW_BYTES_LITERAL=321, UNCLOSED_TRIPLE_QUOTED_RAW_BYTES_LITERAL=322, 
		FLOATING_POINT_LITERAL=323, INTEGER_LITERAL=324, IDENTIFIER=325, UNCLOSED_ESCAPED_IDENTIFIER=326, 
		WHITESPACE=327, COMMENT=328;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NOT_SYMBOL", "AND_SYMBOL", "OR_SYMBOL", "JSON_SYMBOL", "DATE_SYMBOL", 
			...
			"NEW_SYMBOL", "END_SYMBOL", "CASE_SYMBOL", "WHEN_SYMBOL", "THEN_SYMBOL", 
			"ELSE_SYMBOL", "CAST_SYMBOL", "EXTRACT_SYMBOL", "COLLATE_SYMBOL", "IF_SYMBOL", 
			"GROUPING_SYMBOL", "HAVING_SYMBOL", "GROUP_SYMBOL", "ROLLUP_SYMBOL", 
			...
			"EXISTS_SYMBOL", "NOT_SPECIAL_SYMBOL", "ANY_SYMBOL", "SOME_SYMBOL", "LIKE_SYMBOL", 
			"MINUS_SYMBOL", "PLUS_SYMBOL", "ASTERISK_SYMBOL", "COMMA_SYMBOL", "DOT_SYMBOL", 
			"EQUAL_SYMBOL", "LC_BRACKET_SYMBOL", "RC_BRACKET_SYMBOL", "LT_BRACKET_SYMBOL", 
			"GT_BRACKET_SYMBOL", "LR_BRACKET_SYMBOL", "RR_BRACKET_SYMBOL", "LS_BRACKET_SYMBOL", 
			...
			"UNCLOSED_STRING_LITERAL", "UNCLOSED_TRIPLE_QUOTED_STRING_LITERAL", "UNCLOSED_RAW_STRING_LITERAL", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'BIGDECIMAL'", "'NOT'", "'AND'", "'OR'", "'JSON'", "'DATE'", "'TIME'", 
			"'DATETIME'", "'TIMESTAMP'", "'RANGE'", "'INTERVAL'", "'SIMPLE'", "'ABORT'", 
			"'ACCESS'", "'ACTION'", "'AGGREGATE'", "'ADD'", "'ALTER'", "'ALWAYS'", 
			"'ANALYZE'", "'APPROX'", "'ARE'", "'ASSERT'", "'BATCH'", "'BEGIN'", "'BREAK'", 
			"'CALL'", "'CASCADE'", "'CHECK'", "'CLAMPED'", "'CLONE'", "'COPY'", "'CLUSTER'", 
			...
			"'DESCRIPTOR'", "'INTERLEAVE'", "'NULL_FILTERED'", "'PARENT'", "'NEW'", 
			"'END'", "'CASE'", "'WHEN'", "'THEN'", "'ELSE'", "'CAST'", "'EXTRACT'", 
			"'COLLATE'", "'IF'", "'GROUPING'", "'HAVING'", "'GROUP'", "'ROLLUP'", 
			"'CUBE'", "'HASH'", "'PROTO'", "'PARTITION'", "'IGNORE'", "'RESPECT'", 
			"'ROWS'", "'OVER'", "'BETWEEN'", "'UNBOUNDED'", "'CURRENT'", "'PRECEDING'", 
			"'FOLLOWING'", "'NATURAL'", "'QUALIFY'", "'DEFAULT'", "'SLASH'", "'MATCH_RECOGNIZE'", 
			"'DEFINE'", "'LOOKUP'", "'WHERE'", "'WINDOW'", "'TO'", "'EXISTS'", "'NOT_SPECIAL'", 
			"'ANY'", "'SOME'", "'LIKE'", "'-'", "'+'", "'*'", "','", "'.'", "'='", 
			"'{'", "'}'", "'<'", "'>'", "'('", "')'", "'['", "']'", "'|'", "':'", 
			"';'", "'''", "'''''", "'\"'", "'\"\"\"'", "'`'", "'?'", "'@'", "'@@'", 
			"'=>'", "'->'", "'+='", "'-='", "'|>'"
	...
	public GoogleSQLLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "GoogleSQLLexer.g4"; }
